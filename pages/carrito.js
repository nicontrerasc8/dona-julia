  ...
  return <div className='pagina'>
    {
        ...
        <div className='carrito'>
            ...
            <a href={`https://api.whatsapp.com/send?phone=51987265986&text="¡Hola! Vengo de su página web. Mi pedido es el siguiente: ${FinalWhatsAppString}"`}  target={"_blank"} rel="noreferrer">
